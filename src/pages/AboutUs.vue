<template>
    <div>
        <v-container>
            ...
            <h3 style="margin-top: 20px;">📝 项目介绍</h3>
            <p style="margin-top: 20px;">
                航迹是一个 <a href="https://www.mocd.cc/">Ministry of CODE</a> 推出的航班聚合平台，旨在为XMUMers提供一个更加方便的航班查询平台及同航班同学的交流平台。
            </p>
            <p style="margin-top: 20px;">
                共翼天行，航迹同校。飞扬路上，同行为友。
            </p>
            <p style="margin-top: 20px;">
                <span style="font-weight:900;">「Bandara」</span> /bɑːnˈdɑːrə/，印尼语，意为「机场」。
            </p>
            ...
            <p style="margin-top: 20px;">
                航迹项目开源于 <span style="font-weight:900;">暂未开源</span>，欢迎大家参与贡献！
            </p>
        </v-container>
    </div>
</template>
